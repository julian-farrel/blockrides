...
export const CONTRACT_ABI = [
	{
		"anonymous": false,
		"inputs": [
			{ "indexed": true, "internalType": "address", "name": "driverAddress", "type": "address" },
	...
	},
	{
		...
		"inputs": [
			...
			{ "indexed": false, "internalType": "string", "name": "pickup", "type": "string" },
	...
	},
	{
		...
		"outputs": [
			...
			{ "internalType": "string", "name": "plateNumber", "type": "string" },
			{ "internalType": "string", "name": "vehicleType", "type": "string" },
			{ "internalType": "string", "name": "rateType", "type": "string" },
		...
		"outputs": [
			{
				"components": [
					...
					{ "internalType": "enum BlockRides.RideStatus", "name": "status", "type": "uint8" },
		...
		"outputs": [
			{
				...
				"internalType": "struct BlockRides.Driver",
				"name": "",
				"type": "tuple"
			}
		],
	...
	},
	{
		"inputs": [
			...
			{ "internalType": "string", "name": "_plateNumber", "type": "string" },
			{ "internalType": "string", "name": "_vehicleType", "type": "string" },
			{ "internalType": "string", "name": "_rateType", "type": "string" }
		],
		"name": "registerDriver",
		"outputs": [],
		"stateMutability": "nonpayable",
